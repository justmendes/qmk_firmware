 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | ~L2  |  '"  |AltShf| Left | Right|                                       |  Up  | Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_FN2,         KC_QUOT,      LALT(KC_LSFT),  KC_LEFT,KC_RGHT,
        ...
        // right hand
             ...
             KC_FN1,       KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                                  KC_UP,  KC_DOWN,KC_LBRC,KC_RBRC,          MEH_T(KC_NO),
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_AMPR, KC_BSLS,KC_ASTR, KC_PLUS, KC_EQL,  KC_F12,
